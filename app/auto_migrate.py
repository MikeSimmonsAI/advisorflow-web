...
COLUMNS_TO_ADD = [
    ...
    # THE ORIGINAL import_batches / import_staged_rows COLUMNS. Production's
    # tables predate the model they are read through (found 2026-09-26:
    # "column import_batches.created_by_id does not exist" the first time
    # Universal Intake wrote a batch). create_all never alters an existing
    # table, so every model column is listed here; IF NOT EXISTS makes the ones
    # already present a no-op.
    ("import_batches", "organization_id", "VARCHAR"),
    ("import_batches", "created_by_id", "VARCHAR"),
    ("import_batches", "created_by_name", "VARCHAR"),
    ("import_batches", "display_name", "VARCHAR"),
    ("import_batches", "source_type", "VARCHAR"),
    ("import_batches", "source_filename", "VARCHAR"),
    ("import_batches", "status", "VARCHAR"),
    ("import_batches", "total_rows", "INTEGER"),
    ("import_batches", "new_rows", "INTEGER"),
    ("import_batches", "matched_rows", "INTEGER"),
    ("import_batches", "warning_rows", "INTEGER"),
    ("import_batches", "rejected_rows", "INTEGER"),
    ("import_batches", "pending_rows", "INTEGER"),
    ("import_batches", "committed_rows", "INTEGER"),
    ("import_batches", "merged_rows", "INTEGER"),
    ("import_batches", "invalid_rows", "INTEGER"),
    ("import_batches", "error_message", "TEXT"),
    ("import_batches", "committed_at", "TIMESTAMP"),
    ("import_batches", "committed_by_id", "VARCHAR"),
    ("import_batches", "committed_by_name", "VARCHAR"),
    ("import_batches", "archived_at", "TIMESTAMP"),
    ("import_batches", "created_at", "TIMESTAMP"),
    ("import_batches", "updated_at", "TIMESTAMP"),
    ("import_staged_rows", "batch_id", "VARCHAR"),
    ("import_staged_rows", "organization_id", "VARCHAR"),
    ("import_staged_rows", "row_number", "INTEGER"),
    ("import_staged_rows", "raw_data", "TEXT"),
    ("import_staged_rows", "first_name", "VARCHAR"),
    ("import_staged_rows", "last_name", "VARCHAR"),
    ("import_staged_rows", "phone_raw", "VARCHAR"),
    ("import_staged_rows", "phone_normalized", "VARCHAR"),
    ("import_staged_rows", "email_raw", "VARCHAR"),
    ("import_staged_rows", "email_normalized", "VARCHAR"),
    ("import_staged_rows", "tier", "VARCHAR"),
    ("import_staged_rows", "relationship_type", "VARCHAR"),
    ("import_staged_rows", "source_category", "VARCHAR"),
    ("import_staged_rows", "street_address", "VARCHAR"),
    ("import_staged_rows", "city", "VARCHAR"),
    ("import_staged_rows", "state", "VARCHAR"),
    ("import_staged_rows", "zip_code", "VARCHAR"),
    ("import_staged_rows", "extra_fields", "TEXT"),
    ("import_staged_rows", "validation_status", "VARCHAR"),
    ("import_staged_rows", "validation_errors", "TEXT"),
    ("import_staged_rows", "duplicate_status", "VARCHAR"),
    ("import_staged_rows", "match_confidence", "VARCHAR"),
    ("import_staged_rows", "matched_lead_id", "VARCHAR"),
    ("import_staged_rows", "duplicate_of_staged_row_id", "VARCHAR"),
    ("import_staged_rows", "match_reason", "VARCHAR"),
    ("import_staged_rows", "review_status", "VARCHAR"),
    ("import_staged_rows", "review_note", "TEXT"),
    ("import_staged_rows", "reviewed_by_id", "VARCHAR"),
    ("import_staged_rows", "reviewed_at", "TIMESTAMP"),
    ("import_staged_rows", "committed_lead_id", "VARCHAR"),
    ("import_staged_rows", "merged_into_lead_id", "VARCHAR"),
    ("import_staged_rows", "committed_by_id", "VARCHAR"),
    ("import_staged_rows", "committed_at", "TIMESTAMP"),
    ("import_staged_rows", "created_at", "TIMESTAMP"),
    ("import_staged_rows", "updated_at", "TIMESTAMP"),
